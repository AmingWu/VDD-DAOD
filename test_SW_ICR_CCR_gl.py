...
from model.da_faster_rcnn_instance_da_weight.resnet_glnew import resnet
...
if __name__ == "__main__":
    ...
    for i in range(num_images):
        ...
        with torch.no_grad():
            ...
            rois_label,d_pred,_,_,_,_ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, phase=1)
