...
if __name__ == "__main__":
    ...
    bustxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_bus.txt', 'a+')
    biketxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_bike.txt', 'a+')
    cartxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_car.txt', 'a+')
    motortxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_motor.txt', 'a+')
    persontxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_person.txt', 'a+')
    ridertxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_rider.txt', 'a+')
    trucktxt = open('/home/wam/newdecomposition/SW_Faster_ICR_CCR2/Results/comp4_det_test_truck.txt', 'a+')
    txtlist = [bustxt, biketxt, cartxt, motortxt, persontxt, ridertxt, trucktxt]
    namelist = []
    ...
    for i in range(num_images):
        ...
        namelist.append(imdb.image_path_at(i))
    ...
    pdb.set_trace()
    result_box = np.array(all_boxes)
    for m in range(1, result_box.shape[0]):
        for n in range(result_box.shape[1]):
            nowresult = result_box[m][n]
            for k in range(nowresult.shape[0]):
                newresult = nowresult[k]
                txtlist[m-1].write(namelist[n] + ' ' + str(np.around(newresult[4], decimals=3)) + ' ' + str(np.around(newresult[0], decimals=1)) + ' ' + str(np.around(newresult[1], decimals=1)) + ' ' + str(np.around(newresult[2], decimals=1)) + ' ' + str(np.around(newresult[3], decimals=1)))
                txtlist[m-1].write('\n')
